...
---------------------
Ported from disslucc-discrete/tests/test_demand.py. Substrate-neutral
(DemandPreComputedValues has no gdf/backend dependency), so it applies
unchanged to disslucc's raster-only port.
"""
